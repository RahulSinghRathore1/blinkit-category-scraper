...
class BlinkitConfig {
    constructor() {
        ...
        this.apiVersion = 'v1';
        this.deviceId = process.env.DEVICE_ID || 'a2e6f47e-b4f2-438a-a8b6-08670b5d84df';
        this.sessionUuid = process.env.SESSION_UUID || '7d5a3899-d3a3-4c3d-b5d5-68d40a3cb77f';
        this.authKey = process.env.AUTH_KEY || 'c761ec3633c22afad934fb17a66385c1c06c5472b4898b866b7306186d0bb477';
    }
